...
export const aiInsights: AIInsight[] = [
  {
    ...
    message: "You spend more on food delivery when workdays go past 10 hours. That's human. But a quick meal prep on Sunday could save you around $180/month.",
    icon: "moon",
  ...
  },
  {
    ...
    message: "You have 6 active subscriptions totaling $145/month. When's the last time you used Apple TV+?",
    icon: "credit-card",
  ...
  },
  {
    ...
    message: "Switching your daily coffee from Starbucks to making it at home could save you $120/month. That's $1,440/year toward your goals.",
    icon: "coffee",
  },
];
...
export const vibeDescriptions = {
  control: {
    title: "I want control",
    description: "You want to know exactly where every dollar goes. Budgets are your friend.",
    aiHelp: "I'll help you track spending patterns, set up budgets, and spot areas where money might be slipping through the cracks.",
  },
  save: {
    title: "I want to save",
    description: "Building that emergency fund or saving for something specific is your priority.",
    aiHelp: "I'll help you set realistic savings goals, find money you didn't know you had, and celebrate your wins along the way.",
  },
  invest: {
    title: "I want to invest",
    description: "You're ready to make your money work for you and think about the long game.",
    aiHelp: "I'll explain investing concepts in plain English, help you understand your options, and guide you toward getting started.",
  },
  "figuring-out": {
    title: "I'm just figuring things out",
    description: "No shame in that. Everyone starts somewhere.",
    aiHelp: "I'll help you understand your current situation, answer your questions without judgment, and suggest small steps you can take.",
  },
};

// Income range options for onboarding
export const incomeRanges = [
  { value: 2000, label: "Under $2,500" },
  { value: 3000, label: "$2,500 - $3,500" },
  { value: 4000, label: "$3,500 - $4,500" },
  { value: 5000, label: "$4,500 - $5,500" },
  { value: 6000, label: "$5,500 - $7,000" },
