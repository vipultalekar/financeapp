      ...
      <Link to={nudge.href} className="block">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="font-black text-xs sm:text-sm text-white uppercase tracking-tight group-hover:text-primary transition-colors">
              {nudge.label}
            </p>
            <p className="text-[10px] sm:text-xs text-muted-foreground/40 font-bold uppercase tracking-widest mt-0.5">
              {nudge.description}
            </p>
          </div>
