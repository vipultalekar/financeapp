...
function CustomTooltip({ active, payload, label, formatCurrency }: CustomTooltipProps) {
  if (active && payload && payload.length) {
    return (
      <div className="glass-card-3d px-4 py-3 glow-teal border-primary/20">
        <p className="text-[8px] font-black text-muted-foreground/60 uppercase tracking-widest mb-1">{label}</p>
        <p className="text-lg font-black text-primary shimmer-text tabular-nums">
    ...
    <div className="glass-card-3d p-4 md:p-6 card-3d-hover group">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2 text-[9px] font-black uppercase tracking-widest">
          <span className="text-muted-foreground/30">Current Balance:</span>
          <span className="text-primary shimmer-text">
