...
export function AddCategoryDialog({ open, onOpenChange, onSave, initialData }: AddCategoryDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            */}
            <DialogContent className="fixed bottom-0 left-0 right-0 top-auto translate-x-0 translate-y-0 w-full max-w-none h-auto max-h-[85vh] rounded-t-[1.25rem] rounded-b-none border-t border-white/10 bg-card/80 backdrop-blur-xl shadow-2xl flex flex-col p-0 overflow-hidden sm:fixed sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-[500px] sm:w-full sm:rounded-[1.25rem] sm:border">
